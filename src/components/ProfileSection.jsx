...
const ProfileSection = () => {
    return (
        <motion.div variants={fadeIn("", "", 0.3)} className="container mx-auto flex flex-col items-center sm:items-start">
            <div className="grid grid-cols-1 sm:grid-cols-4 gap-6 items-center w-full max-w-4xl">
                ...
                <motion.div variants={textVariant()} className="col-span-1 text-center sm:text-left sm:-mt-10 mt-10">
